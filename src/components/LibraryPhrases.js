...
import { transportPlayToggle } from 'reducers/reduceTransport'
        ...
        <div className="container library-body-container">
          ...
          <div className="library-selection-pane">
            <ul className="stories" tabIndex={0} ref={ref => this.selectionPane = ref}>
              { this.renderSelectionPaneResults({ phrases: this.props.phrases }) }
            </ul>
          </div>
...
export default connect(mapStateToProps)(LibraryPhrases)
