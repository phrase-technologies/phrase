...
export const pianorollSelectionStart      = (x, y)            => ({type: pianoroll.SELECTION_BOX_START, x, y})
export const pianorollSelectionEnd        = (x, y)            => ({type: pianoroll.SELECTION_BOX_END,   x, y})
